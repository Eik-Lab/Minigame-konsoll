...
void mFunc_run_pacman(uint8_t param)
// *********************************************************************
{
  if (LCDML.FUNC_setup()) { // ****** SETUP *********
  ...
  if (LCDML.FUNC_loop()) { // ****** LOOP *********
    ...
    pacman_loop(is_running);
  }

  if (LCDML.FUNC_close()) { // ****** STABLE END *********
    // Clean up or reset any necessary variables
    is_running = false;
  }
}

// *********************************************************************
void mFunc_run_hangman(uint8_t param)
// *********************************************************************
{
  if(LCDML.FUNC_setup())          // ****** SETUP *********
  {
...
// *********************************************************************
void mFunc_run_dinorun(uint8_t param)
// *********************************************************************
{
  if(LCDML.FUNC_setup())          // ****** SETUP *********
  {
